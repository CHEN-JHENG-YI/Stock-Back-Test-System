...
3. Read the relevant `.cursor/skills/*/SKILL.md` rules.
4. Confirm the work passes [`Docs/DEFINITION_OF_DONE.md`](Docs/DEFINITION_OF_DONE.md) before declaring a task complete.
